...
// with little bugfix from:
// http://www.rgagnon.com/javadetails/java-0630.html
// I'd some problems reading some Registry keys. Had to change: in method readStringValues() : 
// line "int maxlen = info[3]; // value length max 
// TO int maxlen = info[4]; // value lenght max 
